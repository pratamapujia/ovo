...
@section('title')
  <title>Form Tambah Pemilih</title>
@endsection
  ...
  <div id="main-content">
    ...
    <div class="page-content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('pemilih.store') }}" class="form" method="POST">
            @csrf
            <div class="row">
              <div class="col-sm-12 col-md-4">
                <div class="form-group">
                  <label class="form-label" for="nis">NIS</label>
                  <input type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" placeholder="Masukkan NIS" value="{{ old('nis') }}">
                  @error('nis')
              ...
              <div class="col-sm-12 col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nama_pemilih') is-invalid @enderror" name="nama_pemilih" placeholder="Masukkan Nama" value="{{ old('nama_pemilih') }}">
                  @error('nama_pemilih')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
