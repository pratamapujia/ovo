  ...
  <div id="main-content">
    ...
    <div class="page-content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('jurusan.store') }}" class="form" method="POST">
            @csrf
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  <label class="form-label" for="nama_jurusan">Nama Jurusan</label>
                  <input type="text" class="form-control @error('nama_jurusan') is-invalid @enderror" name="nama_jurusan" placeholder="Masukkan Nama Jurusan" value="{{ old('nama_jurusan') }}">
                  @error('nama_jurusan')
