                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      ...
                      <textarea class="@error('visi') is-invalid @enderror" id="default" name="visi" value="{{ old('visi') }}"></textarea>
                      @error('visi')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      ...
                      <textarea class="@error('misi') is-invalid @enderror" id="default" name="misi" value="{{ old('misi') }}"></textarea>
                      @error('misi')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
